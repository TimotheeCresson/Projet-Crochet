        ...
        <nav class="barreNav barreNavDisplay">
            <ul>
                <input type="checkbox" id="check">
                    ...
                    <li>
    <a href="<?php echo isset($_SESSION['logged']) && $_SESSION['logged'] === true ? '/php/admin/' . ($_SESSION['role'] === 'Admin' ? 'adminCompte.php' : '/php/view/' . ($_SESSION['role'] === 'user' ? 'userCompte.php' : '')) : '/compte';?>" id="compteLink">Compte</a>
</li>
